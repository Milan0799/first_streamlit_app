...
fruityvice_response_1 = requests.get("https://fruityvice.com/api/fruit/" + fruit_choice_1)
fruityvice_normalized_1 = pandas.json_normalize(fruityvice_response_1.json())
streamlit.dataframe(fruityvice_normalized_1)
